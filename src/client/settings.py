...
class Settings(CommonSettings):
    ...
    # Secret settings
    secret_provider: Optional[SecretProvider] = Field(None, description="The provider where the secret is stored")
    secret_identifier: Optional[str] = Field(None, description="The identifier for the secret")
